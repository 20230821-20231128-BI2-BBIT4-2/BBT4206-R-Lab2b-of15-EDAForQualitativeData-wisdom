...
## The following code defines a blue grey color scheme for visualizations
...
##The code customize the text tables for consistency using html forecasting 
...
library(readr)
=======
##The following code evaluates reading of contents before lectures by students per gender in a plane tabular output
...
library(readr)
=======
##The following code evaluates reading of contents before lectures by students per gender in a visual bar chart
